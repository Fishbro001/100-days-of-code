...
**Today's Progress**: Started on Intermediate programming course on FreeCodeCamp

**Thoughts**: Googling helps, pretty hard so far. 
 Days to add: +6
...
**Today's Progress**: Halfway through on Intermediate programming course on FreeCodeCamp

**Thoughts**: I take 2< hours on a problem, maybe I should just check the hints.
...
**Today's Progress**: Almost done on Intermediate programming course on FreeCodeCamp

**Thoughts**: I grind at each problem, and I enjoy it, but I feel like I'm wasting time for no reason, and should just ask for solution.
...
**Today's Progress**: Done on Intermediate programming course on FreeCodeCamp
